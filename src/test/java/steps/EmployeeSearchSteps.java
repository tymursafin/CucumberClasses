...
public class EmployeeSearchSteps extends CommonMethods {
    ...
    public void user_enters_valid_employee_name() {
        //WebElement searchNameField = driver.findElement(By.xpath("//input[@id='empsearch_employee_name_empName']"));
        //sendText(searchNameField, "aider khalilov");
        sendText(employeeListPage.empSearchNameField,"aider");
    }
